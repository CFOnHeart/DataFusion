...
//        System.out.println("TFIDFExcutor topK: " + job.getTopicNum());
        if(job.getCorpusSourceId() == null || job.getCorpusTableName() == null || job.getTopicNum() == 0 || job.getTableName() == null || job.getDataSourceId() == null){
            ...
            Map<String, List<String>> keyWords = BTM.btmByMysql(corpus , job.getTopicNum());
